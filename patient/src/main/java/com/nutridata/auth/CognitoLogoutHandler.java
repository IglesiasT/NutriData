...
public class CognitoLogoutHandler extends SimpleUrlLogoutSuccessHandler {
     ...
     */
    private String domain = "https://sa-east-1wmugxh7lc.auth.sa-east-1.amazoncognito.com/";

    /**
     * An allowed callback URL.
     */
    private String logoutRedirectUrl = "<logout uri>"; // This should be the home page

    /**
     * The ID of your User Pool Client.
     */
    private String userPoolClientId = "7vlhg6noe76cqf40q0sk801d8k";
